...
export const THEME_STYLES: Record<Theme, ThemeStyles> = {
  violet: {
    ...
    card: "topic-card bg-white/[0.07] border border-white/12 hover:bg-white/[0.1] hover:border-indigo-400/45 text-slate-100 shadow-md shadow-black/20",
  ...
  dark: {
    ...
    card: "topic-card bg-slate-900/80 border border-slate-700/80 hover:bg-slate-900 hover:border-indigo-500/45 text-slate-200 shadow-md shadow-black/30",
  ...
  light: {
    ...
    card: "topic-card bg-white/95 border border-slate-200 hover:bg-white hover:border-indigo-400/50 text-slate-800 shadow-sm shadow-indigo-500/5",
